...
Uso: python quarantine_revert_20260830.py [--only-good]
  (sem flag)   reverte TODOS os 205 leads do snapshot
...
MARK = 'quarantine-extrator-20260830'
EVID = r'D:\claude-code\diax-crm\docs\email-marketing\quarantine-extrator-20260830.json'
