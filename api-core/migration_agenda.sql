...
CREATE INDEX [IX_Customers_Document] ON [customers] ([document]) WHERE [document] IS NOT NULL;
GO
...
INSERT INTO [income_categories] ([id], [created_at], [created_by], [is_active], [name], [updated_at], [updated_by])
...
GO
                ...
                VALUES (
                    '4330348c-3082-4214-bf61-c4be83e82f90',
...
GO
                ...
                UPDATE incomes
                SET financial_account_id = '4330348c-3082-4214-bf61-c4be83e82f90'
...
GO
                ...
                SET balance = (
                    ...
                    FROM incomes
                    WHERE financial_account_id = '4330348c-3082-4214-bf61-c4be83e82f90'
                )
                WHERE id = '4330348c-3082-4214-bf61-c4be83e82f90'
...
UPDATE [incomes] SET [financial_account_id] = '00000000-0000-0000-0000-000000000000' WHERE [financial_account_id] IS NULL;
...
INSERT INTO [expense_categories] ([id], [created_at], [created_by], [is_active], [name], [updated_at], [updated_by])
...
UPDATE [expense_categories] SET [user_id] = '11111111-1111-1111-1111-111111111111'
...
UPDATE [income_categories] SET [user_id] = '11111111-1111-1111-1111-111111111111'
...
ALTER TABLE [imported_transactions] ADD [created_transaction_id] uniqueidentifier NULL;
GO

ALTER TABLE [imported_transactions] ADD [matched_transaction_id] uniqueidentifier NULL;
GO

ALTER TABLE [imported_transactions] ADD [suggested_type] int NULL;
GO
...
CREATE TABLE [transactions] (
    ...
    [financial_account_id] uniqueidentifier NULL,
    [credit_card_id] uniqueidentifier NULL,
    [credit_card_invoice_id] uniqueidentifier NULL,
    [status] int NOT NULL,
    [paid_date] datetime2 NULL,
    [transfer_group_id] uniqueidentifier NULL,
    [account_transfer_id] uniqueidentifier NULL,
    [created_at] datetime2 NOT NULL,
    [created_by] nvarchar(256) NULL,
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(256) NULL,
    CONSTRAINT [PK_transactions] PRIMARY KEY ([id]),
    CONSTRAINT [FK_transactions_account_transfers_account_transfer_id] FOREIGN KEY ([account_transfer_id]) REFERENCES [account_transfers] ([id]) ON DELETE SET NULL,
    CONSTRAINT [FK_transactions_credit_card_invoices_credit_card_invoice_id] FOREIGN KEY ([credit_card_invoice_id]) REFERENCES [credit_card_invoices] ([id]) ON DELETE SET NULL,
    CONSTRAINT [FK_transactions_credit_cards_credit_card_id] FOREIGN KEY ([credit_card_id]) REFERENCES [credit_cards] ([id]) ON DELETE SET NULL,
    CONSTRAINT [FK_transactions_financial_accounts_financial_account_id] FOREIGN KEY ([financial_account_id]) REFERENCES [financial_accounts] ([id]) ON DELETE SET NULL,
    CONSTRAINT [FK_transactions_transaction_categories_category_id] FOREIGN KEY ([category_id]) REFERENCES [transaction_categories] ([id]) ON DELETE NO ACTION
);
GO

IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'applicable_to', N'created_at', N'created_by', N'is_active', N'name', N'updated_at', N'updated_by', N'user_id') AND [object_id] = OBJECT_ID(N'[transaction_categories]'))
    SET IDENTITY_INSERT [transaction_categories] ON;
INSERT INTO [transaction_categories] ([id], [applicable_to], [created_at], [created_by], [is_active], [name], [updated_at], [updated_by], [user_id])
VALUES ('10000000-0000-0000-0000-000000000001', 1, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Salário', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000002', 1, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Serviço', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000003', 1, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Marketing', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000004', 1, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Venda', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000005', 1, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Comissão', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000006', 3, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Reembolso', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000007', 3, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Empréstimo', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('10000000-0000-0000-0000-000000000008', 3, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Outros', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000001', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Alimentação', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000002', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Transporte', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000003', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Moradia', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000004', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Saúde', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000005', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Educação', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000006', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Lazer', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000007', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Vestuário', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000008', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Serviços', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000009', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Impostos', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000010', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Investimentos', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000011', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Marketing', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000012', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Equipamentos', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000013', 2, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Fornecedores', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000014', 3, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Não Categorizado', NULL, NULL, '11111111-1111-1111-1111-111111111111'),
('20000000-0000-0000-0000-000000000015', 3, '2025-01-01T00:00:00.0000000Z', NULL, CAST(1 AS bit), N'Outros', NULL, NULL, '11111111-1111-1111-1111-111111111111');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'id', N'applicable_to', N'created_at', N'created_by', N'is_active', N'name', N'updated_at', N'updated_by', N'user_id') AND [object_id] = OBJECT_ID(N'[transaction_categories]'))
    SET IDENTITY_INSERT [transaction_categories] OFF;
GO

CREATE INDEX [IX_imported_transactions_created_transaction_id] ON [imported_transactions] ([created_transaction_id]);
GO

CREATE INDEX [IX_imported_transactions_matched_transaction_id] ON [imported_transactions] ([matched_transaction_id]);
GO

CREATE INDEX [IX_transaction_categories_user_id] ON [transaction_categories] ([user_id]);
GO

CREATE INDEX [IX_transactions_account_transfer_id] ON [transactions] ([account_transfer_id]);
GO

CREATE INDEX [IX_transactions_category_id] ON [transactions] ([category_id]);
GO

CREATE INDEX [IX_transactions_credit_card_id] ON [transactions] ([credit_card_id]);
GO

CREATE INDEX [IX_transactions_credit_card_invoice_id] ON [transactions] ([credit_card_invoice_id]);
GO

CREATE INDEX [IX_transactions_financial_account_id] ON [transactions] ([financial_account_id]);
GO

CREATE INDEX [IX_transactions_transfer_group] ON [transactions] ([transfer_group_id]) WHERE [transfer_group_id] IS NOT NULL;
GO

CREATE INDEX [IX_transactions_user_account] ON [transactions] ([user_id], [financial_account_id]);
GO
...
CREATE INDEX [IX_transactions_user_type_date] ON [transactions] ([user_id], [type], [date]);
GO

ALTER TABLE [imported_transactions] ADD CONSTRAINT [FK_imported_transactions_transactions_created_transaction_id] FOREIGN KEY ([created_transaction_id]) REFERENCES [transactions] ([id]);
GO

ALTER TABLE [imported_transactions] ADD CONSTRAINT [FK_imported_transactions_transactions_matched_transaction_id] FOREIGN KEY ([matched_transaction_id]) REFERENCES [transactions] ([id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260217082053_AddUnifiedTransactions', N'8.0.11');
GO
...
CREATE TABLE [email_queue_items] (
    ...
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(100) NULL,
    CONSTRAINT [PK_email_queue_items] PRIMARY KEY ([id])
);
GO

CREATE INDEX [IX_EmailQueueItem_SentAt] ON [email_queue_items] ([sent_at]);
GO

CREATE INDEX [IX_EmailQueueItem_Status_ScheduledAt] ON [email_queue_items] ([status], [scheduled_at]);
GO

CREATE INDEX [IX_EmailQueueItem_UserId_CreatedAt] ON [email_queue_items] ([user_id], [created_at]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260219085907_AddEmailQueue', N'8.0.11');
GO
...
ALTER TABLE [email_queue_items] ADD [campaign_id] uniqueidentifier NULL;
GO
...
CREATE TABLE [email_campaigns] (
    ...
    [status] int NOT NULL DEFAULT 0,
    [source_snippet_id] uniqueidentifier NULL,
...
CREATE INDEX [IX_EmailQueueItem_CampaignId] ON [email_queue_items] ([campaign_id]);
GO

CREATE INDEX [IX_email_campaigns_status] ON [email_campaigns] ([status]);
GO

CREATE INDEX [IX_email_campaigns_user_id_created_at] ON [email_campaigns] ([user_id], [created_at]);
GO

ALTER TABLE [email_queue_items] ADD CONSTRAINT [FK_email_queue_items_email_campaigns_campaign_id] FOREIGN KEY ([campaign_id]) REFERENCES [email_campaigns] ([id]) ON DELETE SET NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260219104214_AddEmailCampaignStructure', N'8.0.11');
GO
...
CREATE TABLE [audit_logs] (
    ...
    [changed_properties] nvarchar(1000) NULL,
    [source] int NOT NULL,
    [correlation_id] nvarchar(100) NULL,
...
CREATE INDEX [IX_audit_logs_timestamp_utc] ON [audit_logs] ([timestamp_utc] DESC);
GO

CREATE INDEX [IX_audit_logs_user_id] ON [audit_logs] ([user_id]);
GO

CREATE INDEX [IX_audit_logs_user_timestamp] ON [audit_logs] ([user_id], [timestamp_utc]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260220171549_AddAuditLogsTable', N'8.0.11');
GO
...
CREATE TABLE [image_templates] (
    ...
    [prompt_template] nvarchar(4000) NOT NULL,
    [default_parameters_json] nvarchar(2000) NULL,
    ...
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(256) NULL,
    CONSTRAINT [PK_image_templates] PRIMARY KEY ([id])
);
GO
...
CREATE TABLE [image_generation_projects] (
    ...
    [status] int NOT NULL,
    [parameters_json] nvarchar(4000) NULL,
    [reference_image_url] nvarchar(1000) NULL,
    [created_at] datetime2 NOT NULL,
    [created_by] nvarchar(256) NULL,
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(256) NULL,
    CONSTRAINT [PK_image_generation_projects] PRIMARY KEY ([id]),
    CONSTRAINT [FK_image_generation_projects_image_templates_template_id] FOREIGN KEY ([template_id]) REFERENCES [image_templates] ([id]) ON DELETE SET NULL
);
GO
...
CREATE TABLE [generated_images] (
    ...
    [revised_prompt] nvarchar(4000) NULL,
    [storage_url] nvarchar(1000) NULL,
    [provider_url] nvarchar(1000) NULL,
    [width] int NOT NULL,
    [height] int NOT NULL,
    [seed] nvarchar(100) NULL,
    ...
    CONSTRAINT [FK_generated_images_ai_models_model_id] FOREIGN KEY ([model_id]) REFERENCES [ai_models] ([id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_generated_images_ai_providers_provider_id] FOREIGN KEY ([provider_id]) REFERENCES [ai_providers] ([id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_generated_images_image_generation_projects_project_id] FOREIGN KEY ([project_id]) REFERENCES [image_generation_projects] ([id]) ON DELETE CASCADE
);
GO

CREATE INDEX [IX_generated_images_created_at] ON [generated_images] ([created_at]);
GO

CREATE INDEX [IX_generated_images_model_id] ON [generated_images] ([model_id]);
GO

CREATE INDEX [IX_generated_images_project_id] ON [generated_images] ([project_id]);
GO

CREATE INDEX [IX_generated_images_provider_id] ON [generated_images] ([provider_id]);
GO

CREATE INDEX [IX_generated_images_user_id] ON [generated_images] ([user_id]);
GO

CREATE INDEX [IX_image_generation_projects_status] ON [image_generation_projects] ([status]);
GO

CREATE INDEX [IX_image_generation_projects_template_id] ON [image_generation_projects] ([template_id]);
GO

CREATE INDEX [IX_image_generation_projects_user_id] ON [image_generation_projects] ([user_id]);
GO

CREATE INDEX [IX_image_generation_projects_user_id_created_at] ON [image_generation_projects] ([user_id], [created_at]);
GO

CREATE INDEX [IX_image_templates_category] ON [image_templates] ([category]);
GO

CREATE INDEX [IX_image_templates_is_enabled] ON [image_templates] ([is_enabled]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260223232352_AddImageGenerationTables', N'8.0.11');
GO
...
ALTER TABLE [customers] ADD [email_opt_out] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [customers] ADD [email_sent_count] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [customers] ADD [last_email_sent_at] datetime2 NULL;
GO

ALTER TABLE [customers] ADD [lead_score] int NULL;
GO

ALTER TABLE [customers] ADD [segment] int NULL;
GO

CREATE TABLE [outreach_configs] (
    [id] uniqueidentifier NOT NULL,
    [user_id] uniqueidentifier NOT NULL,
    [apify_dataset_url] nvarchar(1000) NULL,
    [apify_api_token] nvarchar(500) NULL,
    [import_enabled] bit NOT NULL DEFAULT CAST(0 AS bit),
    [segmentation_enabled] bit NOT NULL DEFAULT CAST(0 AS bit),
    [send_enabled] bit NOT NULL DEFAULT CAST(0 AS bit),
    [daily_email_limit] int NOT NULL DEFAULT 200,
    [email_cooldown_days] int NOT NULL DEFAULT 7,
    [hot_template_subject] nvarchar(500) NULL,
    [hot_template_body] nvarchar(max) NULL,
    [warm_template_subject] nvarchar(500) NULL,
    [warm_template_body] nvarchar(max) NULL,
    [cold_template_subject] nvarchar(500) NULL,
    [cold_template_body] nvarchar(max) NULL,
    [created_at] datetime2 NOT NULL,
    [created_by] nvarchar(100) NULL,
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(100) NULL,
    CONSTRAINT [PK_outreach_configs] PRIMARY KEY ([id])
);
GO

CREATE INDEX [IX_Customers_Segment_Status_OptOut] ON [customers] ([segment], [status], [email_opt_out]);
GO

CREATE UNIQUE INDEX [IX_OutreachConfigs_UserId] ON [outreach_configs] ([user_id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225000353_AddOutreachModule', N'8.0.11');
GO
...
ALTER TABLE [outreach_configs] ADD [daily_whats_app_limit] int NOT NULL DEFAULT 100;
GO

ALTER TABLE [outreach_configs] ADD [whats_app_cold_template] nvarchar(4000) NULL;
GO

ALTER TABLE [outreach_configs] ADD [whats_app_cooldown_days] int NOT NULL DEFAULT 3;
GO

ALTER TABLE [outreach_configs] ADD [whats_app_follow_up_template] nvarchar(4000) NULL;
GO

ALTER TABLE [outreach_configs] ADD [whats_app_hot_template] nvarchar(4000) NULL;
GO

ALTER TABLE [outreach_configs] ADD [whats_app_send_enabled] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [outreach_configs] ADD [whats_app_warm_template] nvarchar(4000) NULL;
GO

ALTER TABLE [customers] ADD [last_whats_app_sent_at] datetime2 NULL;
GO

ALTER TABLE [customers] ADD [whats_app_opt_out] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [customers] ADD [whats_app_sent_count] int NOT NULL DEFAULT 0;
GO

CREATE INDEX [IX_Customers_Segment_Status_WhatsAppOptOut] ON [customers] ([segment], [status], [whats_app_opt_out]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225012834_AddWhatsAppOutreach', N'8.0.11');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225091140_CleanupPlaceholderEmails', N'8.0.11');
GO
...
CREATE TABLE [facebook_ad_accounts] (
    [id] uniqueidentifier NOT NULL,
    [user_id] uniqueidentifier NOT NULL,
    [ad_account_id] nvarchar(256) NOT NULL,
    [access_token] nvarchar(256) NOT NULL,
    [account_name] nvarchar(256) NOT NULL,
    [currency] nvarchar(256) NOT NULL,
    [timezone] nvarchar(256) NOT NULL,
    [account_status] nvarchar(256) NOT NULL,
    [is_active] bit NOT NULL,
    ...
    [updated_at] datetime2 NULL,
    [updated_by] nvarchar(256) NULL,
    CONSTRAINT [PK_facebook_ad_accounts] PRIMARY KEY ([id])
);
GO

CREATE INDEX [IX_facebook_ad_accounts_user_id] ON [facebook_ad_accounts] ([user_id]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260227020549_AddFacebookAdsModule', N'8.0.11');
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[facebook_ad_accounts]') AND [c].[name] = N'timezone');
IF @var11 IS NOT NULL EXEC(N'ALTER TABLE [facebook_ad_accounts] DROP CONSTRAINT [' + @var11 + '];');
ALTER TABLE [facebook_ad_accounts] ALTER COLUMN [timezone] nvarchar(64) NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[facebook_ad_accounts]') AND [c].[name] = N'currency');
IF @var12 IS NOT NULL EXEC(N'ALTER TABLE [facebook_ad_accounts] DROP CONSTRAINT [' + @var12 + '];');
ALTER TABLE [facebook_ad_accounts] ALTER COLUMN [currency] nvarchar(10) NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[facebook_ad_accounts]') AND [c].[name] = N'ad_account_id');
IF @var13 IS NOT NULL EXEC(N'ALTER TABLE [facebook_ad_accounts] DROP CONSTRAINT [' + @var13 + '];');
ALTER TABLE [facebook_ad_accounts] ALTER COLUMN [ad_account_id] nvarchar(64) NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[facebook_ad_accounts]') AND [c].[name] = N'account_status');
IF @var14 IS NOT NULL EXEC(N'ALTER TABLE [facebook_ad_accounts] DROP CONSTRAINT [' + @var14 + '];');
ALTER TABLE [facebook_ad_accounts] ALTER COLUMN [account_status] nvarchar(32) NOT NULL;
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[facebook_ad_accounts]') AND [c].[name] = N'access_token');
IF @var15 IS NOT NULL EXEC(N'ALTER TABLE [facebook_ad_accounts] DROP CONSTRAINT [' + @var15 + '];');
ALTER TABLE [facebook_ad_accounts] ALTER COLUMN [access_token] nvarchar(1024) NOT NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260227020641_FixFacebookAdAccountTokenLength', N'8.0.11');
GO
...
ALTER TABLE [email_campaigns] ADD [bounce_count] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [email_campaigns] ADD [click_count] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [email_campaigns] ADD [delivered_count] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [email_campaigns] ADD [unsubscribe_count] int NOT NULL DEFAULT 0;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260228001655_AddEmailCampaignAnalyticsFields', N'8.0.11');
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[email_campaigns]') AND [c].[name] = N'unsubscribe_count');
IF @var16 IS NOT NULL EXEC(N'ALTER TABLE [email_campaigns] DROP CONSTRAINT [' + @var16 + '];');
ALTER TABLE [email_campaigns] ADD DEFAULT 0 FOR [unsubscribe_count];
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[email_campaigns]') AND [c].[name] = N'delivered_count');
IF @var17 IS NOT NULL EXEC(N'ALTER TABLE [email_campaigns] DROP CONSTRAINT [' + @var17 + '];');
ALTER TABLE [email_campaigns] ADD DEFAULT 0 FOR [delivered_count];
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[email_campaigns]') AND [c].[name] = N'click_count');
IF @var18 IS NOT NULL EXEC(N'ALTER TABLE [email_campaigns] DROP CONSTRAINT [' + @var18 + '];');
ALTER TABLE [email_campaigns] ADD DEFAULT 0 FOR [click_count];
GO
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[email_campaigns]') AND [c].[name] = N'bounce_count');
IF @var19 IS NOT NULL EXEC(N'ALTER TABLE [email_campaigns] DROP CONSTRAINT [' + @var19 + '];');
ALTER TABLE [email_campaigns] ADD DEFAULT 0 FOR [bounce_count];
GO

ALTER TABLE [checklist_items] ADD [paid_amount] decimal(18,2) NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260301230146_AddChecklistItemPaidAmount', N'8.0.11');
GO
...
ALTER TABLE [email_queue_items] ADD [delivered_at] datetime2 NULL;
GO

ALTER TABLE [email_queue_items] ADD [opened_at] datetime2 NULL;
GO

ALTER TABLE [email_queue_items] ADD [read_count] int NOT NULL DEFAULT 0;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260302200440_AddEmailTrackingFields', N'8.0.11');
GO
